...
#^ recieved by running the Amplisas on raw fastq data and then executing semi-authomatic "additional_scripts/output_analysis_24_11.R" script

localities <- read.csv("Solea_localities.csv") %>% mutate("INDIVIDUAL_ID" = as.character(INDIVIDUAL_ID))
#^ recieved from collaborators or retrieved from literature
...
#
### PERMUTATIONS ####
#creates input file for permutation tests - python script used for analyses can be found in "additional_sctripts/MHC_allele_sharing_with_permutations_TG_SES.py"
